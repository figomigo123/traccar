...
export const DashboardTableData: DashboardTable[] = [
	...
	{ Name: 'NEM', Icon:'cf cf-xem tx-20 text-teal', Price:'$1547.00', h24:'-11%', MarketCap:'$26,720,210,956', CMGRMonth:'21.30% / 6', Exchange:'Transfer Now'},
	...
	{ Name: 'Litecoin', Icon:'cf cf-ltc tx-20 text-muted', Price:'$173.86', h24:'-7%', MarketCap:'$9,670,920,267', CMGRMonth:'6.87% / 57', Exchange:'Transfer Now'},
