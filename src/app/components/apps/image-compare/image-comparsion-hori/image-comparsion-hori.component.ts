...
@Component({
    selector: 'app-image-comparison-hori',
    styleUrls: ['./image-comparsion-hori.component.scss'],
    templateUrl: './image-comparsion-hori.component.html'
})
export class ComparisonComponent implements OnInit {
    ...
    private initComparison(): void {
        ...
        const fixedImageElement = comparisonElement.querySelector('.fixed-image') ;
